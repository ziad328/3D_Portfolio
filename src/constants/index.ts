...
export const clientReviews = [
    {
        id: 1,
        name: 'Abdallah Wagieh',
        position: 'Freelancer Backend Developer',
        img: 'assets/review1.png',
        review:
            'Working with Ziad on streamFlow was fantastic. As a frontend developer, he delivered fully responsive, dynamic interfaces, slashed bugs, and boosted performance from 35 to 95+. Highly recommended!',
    },
    {
        id: 2,
        name: 'Zack River',
        ...
        review:
            'Ziad was a pleasure to work with. He understood our requirements perfectly and delivered a website that exceeded our expectations. His problem-solving abilities are outstanding.',
    }
];
